...
# --- make imports work no matter where Spyder runs from ---
this_dir = os.path.dirname(os.path.abspath(__file__))          # .../light_mappo-main/train
light_mappo_root = os.path.abspath(os.path.join(this_dir, ".."))  # .../light_mappo-main
project_root = os.path.abspath(os.path.join(light_mappo_root, ".."))  # .../SimCode (contains UE_Selection)

sys.path.insert(0, light_mappo_root)
...
def parse_args(args, parser):
    ...
    parser.add_argument("--num_agents", type=int, default=20, help="number of players")
